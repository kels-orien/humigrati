  ...
  return (
    <React.Fragment>
      <NextHead>
        ...
        <meta
          name="description"
          content="At Humigrati, we have been providing chemicals to the oilfield production market 
        ...
        <meta
          name="keywords"
          content="Humigrati Chemical Company Limited, humigrati,chemicals,chemical,oil,gas, production chemicals,
        ...
        <meta
          name="twitter:card"
          content="Humigrati Chemical Company Limited"
        />
        <meta name="twitter:title" content="" />
        <meta
          name="twitter:description"
          content="Humigrati Chemical Company Limited, humigrati,chemicals,chemical,oil,gas, production"
        />

        <meta
          name="google-site-verification"
          content="zVFJffwpq1FcUMLrdxYOqoqXSjWJ9i3FVsiwIqSkxRM"
        />
      ...
      <div className="top">
        <header className="header">
          <div className="header__container">
            <div className="header__container__in">
              <Link href="/">
            ...
            <div className="header__ul">
              <ul className="header__menu-box">
                <Link href="/">
                  <li className="header__menu-box__in active">
                    <a href="/">Home</a>
                  </li>
                </Link>
                <Link href="/service">
                  <li className="header__menu-box__in">
        ...
        <header className="header-mb">
          <div className="topnav">
            ...
            <div id="myLinks">
              <Link href="/service">
                <a href="/service" className="nav-mb-font">
                  Services
                </a>
              </Link>
              <Link href="/about">
                <a href="/about" className="nav-mb-font">
                  About Us
                </a>
              </Link>
              <Link href="/client">
                <a href="/client" className="nav-mb-font">
                  Clients
                </a>
              </Link>
              <Link href="/contact">
                <a href="/contact" className="nav-mb-font">
                  Contact Us
                </a>
              </Link>
            </div>
            <a className="icon" onClick={handleClick}>
              <span className="burger-mb">
        ...
        <div className="bottom-links">
          <div className="col-footer">
            ...
            <ul className="footer-links">
              <li>
                <span>
                  <i className="bottom-icon ion-md-arrow-dropright" />
                </span>
                <Link href="/service">
                  <a href="#">Products and Applications</a>
                </Link>
              </li>
              <li>
                <i className="bottom-icon ion-md-arrow-dropright" />
                <Link href="/service">
                  <a>Crude Oil Analysis</a>
                </Link>
              </li>
              <li>
                <i className="bottom-icon ion-md-arrow-dropright" />
                <Link href="/service">
                  <a>Effluent Water Monitoring</a>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="col-footer">
            <div>
              ...
              <div className="contact">
                <span>
                  <i className="bottom-icon ion-md-pin" />
                </span>
                22B Dugbo Lane Udu Enerhen Road Warri, Delta State
              </div>
              <div className="contact">
                <span>
                  <i className="bottom-icon ion-md-call" />
                </span>
                +234816975813
              </div>
              <div className="contact">
